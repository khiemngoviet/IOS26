...
NSString * const kDataManagerBundleName = @"StudentTeacher";
NSString * const kDataManagerModelName = @"StudentTeacher";
NSString * const kDataManagerSQLiteName = @"StudentTeacher.sqlite";
